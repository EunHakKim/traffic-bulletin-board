package myboard.articleread.api;
...
public class ArticleReadApiTest {
    ...
    void readTest() {
        ArticleReadResponse response = articleReadRestClient.get()
                .uri("/v1/articles/{articleId}", 148075346164135246L)
                .retrieve()
    ...
    void readAllInfiniteScrollTest() {
        List<ArticleReadResponse> response1 = articleReadRestClient.get()
                .uri("/v1/articles/infinite-scroll?boardId=%s&pageSize=%s&lastArticleId=%s".formatted(1L, 5L, 149495575177875456L))
                .retrieve()
