...
public class CommentApiV2Test {
    ...
    void create() {
         ...
         * response1.getCommentId() = 148419844442804224
         * 	response2.getPath() = 0000000000
         * 	response2.getCommentId() = 148419844950315008
         * 		response3.getPath() = 000000000000000
         * 		response3.getCommentId() = 148419845034201088
         */
    }
    ...
    void readAll() {
        ...
        /**
         * comment.getCommentId() = 148419844442804224
         * comment.getCommentId() = 148419844950315008
         * comment.getCommentId() = 148419845034201088
         * comment.getCommentId() = 148420694829027333
         * comment.getCommentId() = 148420694845804551
         * comment.getCommentId() = 148420694849998867
         * comment.getCommentId() = 148420694849998879
         * comment.getCommentId() = 148420694849998891
         * comment.getCommentId() = 148420694849998901
         * comment.getCommentId() = 148420694849998909
         */
    }
    ...
    void readAllInfiniteScroll() {
        ...
        String lastPath = responses1.get(4).getPath();
